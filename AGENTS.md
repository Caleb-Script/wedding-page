...
> Repository development instructions for **wedding** (Next.js Project).
...
Omnixys Wedding frontend (Next.js 16, MUI, next-intl, Vitest).

- Repository path: `projects/wedding` (relative to the Omnixys root)
...
src/app (App Router), src/components, src/config, src/data, src/hooks, src/i18n; messages/; docs/; reports/
...
Keep the generated `<!-- BEGIN:nextjs-agent-rules -->` block in AGENTS.md intact.
